...
static inline tmpl_DoubleDouble ld_to_dd(long double z)
{
    ...
    const double hi_ldouble = TMPL_CAST(hi, long double);
    const double lo_ldouble = z - hi_ldouble;
...
{
    double r0, r1, r2, r3;
    const double scale = 1.1102230246251565404236316680908203125E-16;
...
static inline tmpl_Bool compare_ld(tmpl_DoubleDouble z0, long double z1)
{
    ...
    const long double eps = 4.0L * TMPL_EPS(val);
