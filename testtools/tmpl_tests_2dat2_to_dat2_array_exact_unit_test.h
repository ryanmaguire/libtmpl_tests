 ...
 ******************************************************************************/
#ifndef TMPL_TESTS_2DAT2_TO_DAT2_ARRAY_EXACT_UNIT_TEST_H
#define TMPL_TESTS_2DAT2_TO_DAT2_ARRAY_EXACT_UNIT_TEST_H

#define TMPL_2DAT2_TO_DAT2_ARRAY_EXACT_UNIT_TEST(type, func, ia0, ia1, oa)     \
int main(void)                                                                 \
{                                                                              \
    const type in0[] = ia0;                                                    \
    const type in1[] = ia1;                                                    \
