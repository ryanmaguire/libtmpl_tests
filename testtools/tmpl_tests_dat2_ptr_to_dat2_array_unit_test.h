 ...
 ******************************************************************************/
#ifndef TMPL_TESTS_DAT2_PTR_TO_DAT2_ARRAY_UNIT_TEST_H
#define TMPL_TESTS_DAT2_PTR_TO_DAT2_ARRAY_UNIT_TEST_H

#define TMPL_DAT2_PTR_TO_DAT2_ARRAY_UNIT_TEST(type, ftype, func, iarr, oarr)   \
int main(void)                                                                 \
{                                                                              \
    const type in[] = iarr;                                                    \
    const type out[] = oarr;                                                   \
