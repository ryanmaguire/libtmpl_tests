 ...
 ******************************************************************************/
#ifndef TMPL_TESTS_REAL_AUT_ODE_INTERVAL_UNIT_TEST_H
#define TMPL_TESTS_REAL_AUT_ODE_INTERVAL_UNIT_TEST_H
 ...
 ******************************************************************************/
#define TMPL_REAL_AUT_ODE_INTERVAL_UNIT_TEST(type, left, right, sol, f, g, ord)\
int main(void)                                                                 \
{                                                                              \
