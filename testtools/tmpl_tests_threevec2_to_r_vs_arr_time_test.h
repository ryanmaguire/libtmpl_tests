 ...
 ******************************************************************************/
#ifndef TMPL_TESTS_THREEVEC2_TO_R_VS_ARR_TIME_TESTS_H
#define TMPL_TESTS_THREEVEC2_TO_R_VS_ARR_TIME_TESTS_H
...
#define TMPL_THREEVEC2_TO_R_VS_ARR_TIME_TESTS(ctype, ttype, ltype, f0, f1)     \
int main(void)                                                                 \
{                                                                              \
    ltype *A, *B;                                                              \
    ttype *X, *Y;                                                              \
