 ...
 ******************************************************************************/
#ifndef TMPL_TESTS_2DAT2_PTR_TO_DAT2_DUP_ARRAY_EXACT_UNIT_TEST_H
#define TMPL_TESTS_2DAT2_PTR_TO_DAT2_DUP_ARRAY_EXACT_UNIT_TEST_H

#define TMPL_2DAT2_PTR_TO_DAT2_DUP_ARRAY_EXACT_UNIT_TEST(type, func, ia, oa)   \
int main(void)                                                                 \
{                                                                              \
    const type in0[] = ia;                                                     \
    const type out[] = oa;                                                     \
    ...
    {                                                                          \
        const type output = func(&in0[n], &in0[n]);                            \
