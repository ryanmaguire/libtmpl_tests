 ...
 ******************************************************************************/
#ifndef TMPL_TESTS_LOGDIFF_PLOT_H
#define TMPL_TESTS_LOGDIFF_PLOT_H
#include <libtmpl/include/compat/tmpl_cast.h>
#include <stdio.h>
#include <stdlib.h>

/*  Macro for plotting libtmpl functions using GNU Plot Utils.                */
#define TMPL_LOGDIFF_PLOT(f0, f1, type, begin, finish, samples, filename)      \
int main(void)                                                                 \
{                                                                              \
    ...
    {                                                                          \
        ...
        const long double abs_errl = tmpl_LDouble_Abs(errl);                   \
        const long double log_errl = log10(abs_errl);                          \
        const long double val = (log_errl < -36.0L ? -36.0L : log_errl);       \
