 ...
 ******************************************************************************/
#ifndef TMPL_TESTS_R2_TO_R_ARRAY_EXACT_UNIT_TEST_H
#define TMPL_TESTS_R2_TO_R_ARRAY_EXACT_UNIT_TEST_H
 ...
 *  Purpose:                                                                  *
 *      Test functions of the form f: R^2 -> R over a given array.            *
 *  Arguments:                                                                *
 *      type:                                                                 *
 ...
 *          The input array.                                                  *
 *      outdata:                                                              *
 *          The output array. To pass we need |func(indata) - outdata| = 0.   *
 ******************************************************************************/
#define TMPL_R2_TO_R_ARRAY_EXACT_UNIT_TEST(type, func, indata, outdata)        \
int main(void)                                                                 \
{                                                                              \
    ...
    {                                                                          \
        ...
        {                                                                      \
            const long double output_ld = TMPL_CAST(output, long double);      \
            const long double out_ld = TMPL_CAST(out[n], long double);         \
            const long double err = TMPL_ERROR_VALUE(output_ld, out_ld);       \
            puts("FAIL");                                                      \
