 ...
 ******************************************************************************/
#ifndef TMPL_TESTS_DAT2_PTR_TO_R_ARRAY_UNIT_TEST_H
#define TMPL_TESTS_DAT2_PTR_TO_R_ARRAY_UNIT_TEST_H

#define TMPL_DAT2_PTR_TO_R_ARRAY_UNIT_TEST(type, ftype, func, inarr, outarr)   \
int main(void)                                                                 \
{                                                                              \
    const type in[] = inarr;                                                   \
