 ...
 ******************************************************************************/
#ifndef TMPL_TESTS_R_TO_R_VS_INTERVAL_UNIT_TEST_H
#define TMPL_TESTS_R_TO_R_VS_INTERVAL_UNIT_TEST_H
 ...
 ******************************************************************************/
#define TMPL_R_TO_R_VS_INTERVAL_UNIT_TEST(type, left, right, f0, f1)           \
int main(void)                                                                 \
{                                                                              \
