 ...
 ******************************************************************************/
#ifndef TMPL_TESTS_2DAT2_PTR_TO_R_DUP_ARRAY_EXACT_UNIT_TEST_H
#define TMPL_TESTS_2DAT2_PTR_TO_R_DUP_ARRAY_EXACT_UNIT_TEST_H

#define TMPL_2DAT2_PTR_TO_R_DUP_ARRAY_EXACT_UNIT_TEST(type, ftype, f, ia, oa)  \
int main(void)                                                                 \
{                                                                              \
    const type in[] = ia;                                                      \
    const ftype out[] = oa;                                                    \
    ...
    {                                                                          \
        const ftype output = f(&in[n], &in[n]);                                \
