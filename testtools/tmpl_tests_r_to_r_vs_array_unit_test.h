 ...
 ******************************************************************************/
#ifndef TMPL_TESTS_R_TO_R_VS_ARRAY_UNIT_TEST_H
#define TMPL_TESTS_R_TO_R_VS_ARRAY_UNIT_TEST_H
 ...
 *          The input array.                                                  *
 ******************************************************************************/
#define TMPL_R_TO_R_VS_ARRAY_UNIT_TEST(type, func0, func1, indata)             \
int main(void)                                                                 \
{                                                                              \
