 ...
 ******************************************************************************/
#ifndef TMPL_TESTS_DD_VS_GMP_POS_UNIT_TEST_H
#define TMPL_TESTS_DD_VS_GMP_POS_UNIT_TEST_H
...
{                                                                              \
    ...
    {                                                                          \
        ...
        {                                                                      \
            ...
            for (yhi = xhi; yhi < number_of_samples; ++yhi)                    \
            {                                                                  \
                const dtype yhi_val = start + TMPL_CAST(yhi, dtype) * ds;      \
                for (ylo = xlo; ylo < number_of_samples; ++ylo)                \
                {                                                              \
