 ...
 ******************************************************************************/
#ifndef TMPL_TESTS_TWOVEC2_TO_VOID_ARRAY_EXACT_UNIT_TEST_H
#define TMPL_TESTS_TWOVEC2_TO_VOID_ARRAY_EXACT_UNIT_TEST_H

#define TMPL_TWOVEC2_TO_VOID_ARRAY_EXACT_UNIT_TEST(type, func, i0, i1, oarr)   \
int main(void)                                                                 \
{                                                                              \
    type in0[] = i0;                                                           \
    const type in1[] = i1;                                                     \
