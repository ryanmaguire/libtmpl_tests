 ...
 ******************************************************************************/
#ifndef TMPL_TESTS_R3_TO_TWOVEC_ARRAY_UNIT_TEST_H
#define TMPL_TESTS_R3_TO_TWOVEC_ARRAY_UNIT_TEST_H
 ...
 *  Purpose:                                                                  *
 *      Test functions of the form f: R^3 -> R^2 over a given array.          *
 *  Arguments:                                                                *
 *      type:                                                                 *
 ...
 ******************************************************************************/
#define TMPL_R3_TO_TWOVEC_ARRAY_UNIT_TEST(type, vtype, func, indata, outdata)  \
int main(void)                                                                 \
{                                                                              \
    struct real3 {type x, y, z;} in[] = indata;                                \
    ...
    {                                                                          \
        const vtype output = func(in[n].x, in[n].y, in[n].z);                  \
