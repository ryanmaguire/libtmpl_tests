...
/*  tmpl_Char_Upper_Case declared here.                                       */
...
/*  Function for testing tmpl_Char_Upper_Case.                                */
int main(void)
{
    /*  Variable for indexing.                                                */
    unsigned int n;

    /*  Character to be used for testing tmpl_Char_Upper_Case.                */
    char c;

    /*  Loop over all letters and test tmpl_Char_Upper_Case.                  */
    for (n = 0; n < 26; ++n)
    {
        /*  Convert the lower case letter to upper case.                      */
        c = tmpl_Char_Upper_Case(lower_arr[n]);
        ...
        c = tmpl_Char_Upper_Case(upper_arr[n]);
